...
layers4_1 = createTConvFinal(2, dropoutFcl, dropoutTConv, dropoutResize, "layers4_1");
...
lgraph = connectLayers(lgraph, 'layers4_1_out', 'regressionoutput');
...
axis('tight')
title("Wavelet Data 250 x 87 (Real), Predict")
