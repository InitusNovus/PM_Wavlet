...
% for k = 152   %For test
    ...
    if writingOriginalTrs
        for whatTrs = trs
            Save_name= Result_Path + "/TimeDomain/" + "/" + whatTrs + "/" + "Ron_" + num2str(R_on) + "_Roff_" + num2str(R_off) + "_Pulse_" + ...
    ...
    % Wavelet Transient
    for whatTrs = trs
        Save_name= Result_Path + "/Wavelet/" + "/" + whatTrs + "/" + "Ron_" + num2str(R_on) + "_Roff_" + num2str(R_off) + "_Pulse_" + ...
            num2str(name_parts{2}) + "_Vds_" + num2str(name_parts{4}) + "_Vgson_" + num2str(Vgs_on) + ...
